...
ServiceType Service::GetType() { return servicetype; }
...
Service::Service(std::string            id,
                 ...
                 ServiceType            type)
    : Buyable(id, name, description, image, rating, price), servicetype(type)
{
}
...
Service::Service(const nlohmann::json& json) { this->Service::fromJSON(json); }
