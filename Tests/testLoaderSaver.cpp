...
void TestLoaderSaver::savePrice()
{
    ...
    QVERIFY(LoaderSaver<Price>::save("testJsons\\priceTest.json", mockPrices));
}
...
void TestLoaderSaver::saveWallet()
{
    ...
    QVERIFY(LoaderSaver<Wallet>::save("testJsons\\walletTest.json", mockWallets));
}
...
void TestLoaderSaver::saveProduct()
{
    ...
    QVERIFY(LoaderSaver<Product>::save("testJsons\\productTest.json", mockProducts));
}
...
void TestLoaderSaver::saveClothing()
{
    ...
    QVERIFY(LoaderSaver<Clothing>::save("testJsons\\clothingTest.json", mockClothing));
}
...
void TestLoaderSaver::saveService()
{
    ...
    QVERIFY(LoaderSaver<Service>::save("testJsons\\serviceTest.json", mockServices));
}
...
void TestLoaderSaver::saveCustomer()
{
    ...
    QVERIFY(LoaderSaver<Customer>::save("testJsons\\customerTest.json", mockCustomers));
}
