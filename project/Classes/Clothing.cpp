...
Clothing::Clothing(std::string id, std::string name, std::string description, std::string image, std::string rating, uint32_t quantity,
                   std::shared_ptr<Price> price, Color color, std::string clothing_type, uint32_t size)
